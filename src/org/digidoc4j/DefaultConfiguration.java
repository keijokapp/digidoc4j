 ...
 * <p/>
 * You can specify the configuration mode, either {@link DefaultConfiguration.Mode#TEST} or {@link DefaultConfiguration.Mode#PROD}
 * configuration. Default is {@link DefaultConfiguration.Mode#PROD}.
 * <p/>
 * It is also possible to set the mode using the System property. Setting the property "digidoc4j.mode" to "TEST" forces
 * the default mode to {@link DefaultConfiguration.Mode#TEST} mode
 * <p/>
...
public class DefaultConfiguration implements Configuration {
   ...
   */
  public DefaultConfiguration(Mode mode) {
   ...
   * Default value is true for {@link DefaultConfiguration.Mode#PROD} and false for {@link DefaultConfiguration.Mode#TEST}
   *
  ...
  /**
   * @return true when configuration is DefaultConfiguration.Mode.TEST
   * @see DefaultConfiguration.Mode#TEST
   */
  ...
  public DefaultConfiguration copy() {
    ...
    DefaultConfiguration copyConfiguration = null;
    // deep copy
    ...
    try {
      ...
      copyConfiguration = (DefaultConfiguration) ois.readObject();
    } catch (Exception e) {
